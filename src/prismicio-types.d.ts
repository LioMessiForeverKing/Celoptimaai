...
export interface BentoSliceDefaultPrimary {
	...
	/**
	 * Subheading field in *Bento → Default → Primary*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: bento.default.primary.subheading
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
...
export interface SignupSliceDefaultPrimary {
	 ...
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: signup.default.primary.heading
	 * - **Documentation**: https://prismic.io/docs/field#rich-text-title
	 */
	heading: prismic.RichTextField;
	 ...
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: signup.default.primary.name
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	name: prismic.KeyTextField;

	/**
	 * Email field in *Signup → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: signup.default.primary.email
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	email: prismic.KeyTextField;

	/**
	 * Excited field in *Signup → Default → Primary*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: signup.default.primary.excited
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	excited: prismic.KeyTextField;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SignupSlice = prismic.SharedSlice<'signup', SignupSliceVariation>;
